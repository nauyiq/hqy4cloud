...
import static com.hqy.rpc.common.CommonConstants.DEFAULT_WEIGHT;
...
public class Metadata implements Serializable {
    ...
    public String getHashFactor() {
        return node == null ? StringConstants.EMPTY : node.getHashFactor();
    }

    public int getWeight() {
        return node == null ? DEFAULT_WEIGHT : node.getWeight();
    }

    public Date serverStartTime() {
        return node == null ? null : node.getCreated();
    }

    public long serverStartTimestamp() {
        return node == null ? 0 : serverStartTime().getTime();
    }
    ...
    public int getParameter(String key, int defaultValue) {
        Map<String, String> ex = node.getEx();
    ...
    public String getParameter(String key, String defaultValue) {
        return node.getParameter(key, defaultValue);
    }
