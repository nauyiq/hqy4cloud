...
import com.hqy.auth.common.vo.AdminUserInfoVO;
...
import static com.hqy.base.common.base.lang.StringConstants.Symbol.COMMA;
...
public class AdminAccountRequestServiceImpl implements AdminAccountRequestService {
    ...
    public DataResponse getPageUsers(String username, String nickname, Long id, Integer current, Integer size) {
        ...
        PageResult<AccountInfoVO> accountInfoDTOPageResult = accountTkService.getPageAccountInfos(username, nickname, maxRoleLevel, current, size);
        return CommonResultCode.dataResponse(SUCCESS, accountInfoDTOPageResult);
    }
