...
import com.hqy.socketio.handler.SuccessAuthorizationListener;
import com.hqy.socketio.listener.DefaultExceptionListener;
import com.hqy.socketio.listener.ExceptionListener;
import com.hqy.socketio.protocol.JsonSupport;
import com.hqy.socketio.store.MemoryStoreFactory;
...
public class Configuration {
     ...
     *
     * @see com.hqy.socketio.store.MemoryStoreFactory
     * @see com.hqy.socketio.store.RedissonStoreFactory
     * @see com.hqy.socketio.store.HazelcastStoreFactory
     */
     ...
     *
     * @see com.hqy.socketio.AuthorizationListener
     */
     ...
     *
     * @see com.hqy.socketio.listener.ExceptionListener
     */
    ...
    public com.hqy.socketio.SocketConfig getSocketConfig() {
        return socketConfig;
    }
    /**
