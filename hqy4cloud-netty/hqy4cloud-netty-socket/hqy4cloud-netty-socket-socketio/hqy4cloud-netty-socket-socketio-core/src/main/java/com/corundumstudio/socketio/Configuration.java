...
public class Configuration {
    ...
    /**
     * Allow to service custom requests differs from socket.io com.hqy.cloud.rpc.thrift.client.protocol.
    ...
    /**
     * Set the name of the requested SSL com.hqy.cloud.rpc.thrift.client.protocol
     *
     * @param sslProtocol - name of com.hqy.cloud.rpc.thrift.client.protocol
     */
    ...
    /**
     * Activate http com.hqy.cloud.rpc.thrift.client.protocol compression. Uses {@code gzip} or
    ...
    /**
     * Activate websocket com.hqy.cloud.rpc.thrift.client.protocol compression.
