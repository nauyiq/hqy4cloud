...
JAVA_OPT="${JAVA_OPT} -Dgateway.home=${BASE_DIR}"
JAVA_OPT="${JAVA_OPT} ${JAVA_OPT_EXT}"
JAVA_OPT="${JAVA_OPT} -Xloggc:${BASE_DIR}/logs/gc-$(date +%Y%m%d-%H%M).log"
JAVA_OPT="${JAVA_OPT} -jar ${BASE_DIR}/target/hqy-gateway-service.jar"
...
echo "Gateway service is starting, you can docker logs your container."
exec $JAVA ${JAVA_OPT}