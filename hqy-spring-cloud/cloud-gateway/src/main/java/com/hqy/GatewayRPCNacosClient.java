...
@Slf4j
@Component
public class GatewayRPCNacosClient extends AbstractNacosClientWrapper  {
    ...
    public ClusterNode setProjectClusterNode() {
        ...
        AssertUtil.notNull(usingIpPort, "System error, Bing rpc port fail. please check thrift service");
