...
@Slf4j
@Component
public class GlobalFlowLimitFilter implements GlobalFilter, Ordered{
    ...
    private void initCustomizedApis() {
        ...
        ApiDefinition api2 = new ApiDefinition("account-auth-service")
                .setPredicateItems(new HashSet<ApiPredicateItem>() {{
                    add(new ApiPathPredicateItem().setPattern("/oauth/**").setMatchStrategy(SentinelGatewayConstants.URL_MATCH_STRATEGY_PREFIX));
                }});
