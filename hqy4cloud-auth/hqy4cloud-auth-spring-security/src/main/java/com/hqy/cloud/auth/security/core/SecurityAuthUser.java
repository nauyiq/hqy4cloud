...
public class SecurityAuthUser extends User implements OAuth2AuthenticatedPrincipal, AuthUser {
    ...
    public SecurityAuthUser(Long id, String username, String password, String email, String phone, Boolean status, Collection<? extends GrantedAuthority> authorities) {
