	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-5">
			<p class="navbar-text navbar-right">
				<a target="_blank" href="https://blog.hongqy1024.cn">技术支持</a>
			</p>
			<p class="navbar-text navbar-right">
                <#if principalName=="anonymousUser">
					未登录
                <#else>
					<a target="_blank" href="https://blog.hongqy1024.cn">${principalName}</a>
                </#if>
			</p>
		</div>
	</div>
...
<footer>
	<p>support by: hqy4cloud</p>
	<p>email: <a href="mailto:759428167@qq.com">759428167@qq.com</a>.</p>
</footer>
</body>
</html>
