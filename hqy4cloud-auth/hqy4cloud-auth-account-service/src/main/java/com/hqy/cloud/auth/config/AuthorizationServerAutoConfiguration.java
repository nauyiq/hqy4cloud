...
import com.hqy.cloud.auth.oauth.core.DefaultDaoAuthenticationProvider;
import com.hqy.cloud.auth.oauth.core.DefaultOauth2TokenCustomizer;
import com.hqy.cloud.auth.oauth.core.FormIdentityLoginConfigurer;
import com.hqy.cloud.auth.oauth.core.RedisOAuth2AuthorizationConsentService;
import com.hqy.cloud.auth.oauth.core.email.Oauth2ResourceOwnerEmailAuthenticationConverter;
import com.hqy.cloud.auth.oauth.core.email.Oauth2ResourceOwnerEmailAuthenticationProvider;
import com.hqy.cloud.auth.oauth.core.password.Oauth2ResourceOwnerPasswordAuthenticationConverter;
import com.hqy.cloud.auth.oauth.core.password.Oauth2ResourceOwnerPasswordAuthenticationProvider;
import com.hqy.cloud.auth.oauth.core.sms.Oauth2ResourceOwnerSmsAuthenticationConverter;
import com.hqy.cloud.auth.oauth.core.sms.Oauth2ResourceOwnerSmsAuthenticationProvider;
import com.hqy.cloud.auth.oauth.handler.DefaultAuthenticationFailureHandler;
import com.hqy.cloud.auth.oauth.handler.DefaultAuthenticationSuccessHandler;
import com.hqy.cloud.auth.oauth.server.DefaultOauth2AccessTokenGenerator;
