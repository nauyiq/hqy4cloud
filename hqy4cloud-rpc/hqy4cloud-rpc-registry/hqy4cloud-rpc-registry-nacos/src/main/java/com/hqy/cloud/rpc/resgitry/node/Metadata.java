package com.hqy.cloud.rpc.resgitry.node;
...
public class Metadata implements Serializable {
    ...
    public Metadata(int weight, int pubNode, RPCServerAddress rpcServerAddress, String hashFactor, ActuatorNodeEnum actuatorType, Map<String, String> metadataParams) {
        this.weight = weight;
