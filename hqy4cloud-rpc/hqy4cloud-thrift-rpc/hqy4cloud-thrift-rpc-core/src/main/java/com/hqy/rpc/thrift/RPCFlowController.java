...
import com.hqy.base.common.base.lang.NumberConstants;
...
public class RPCFlowController {
    ...
    private RPCFlowController() {
        ...
        }, NumberConstants.ONE_MINUTES_4MILLISECONDS * 60, NumberConstants.ONE_MINUTES_4MILLISECONDS, TimeUnit.MILLISECONDS);
    }
