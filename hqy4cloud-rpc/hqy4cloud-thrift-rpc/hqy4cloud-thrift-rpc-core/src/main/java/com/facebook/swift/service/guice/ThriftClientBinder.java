...
public class ThriftClientBinder
{
    ...
    public <T> ClientEventHandlersBinder bindThriftClient(Class<T> clientInterface)
    {
        ...
        ThriftClientProvider<T> provider = new ThriftClientProvider<>(clientInterface, ThriftClientManager.DEFAULT_NAME,
        ...
        ExportBinder.newExporter(binder)
                ...
                .as(String.format("com.facebook.swift.client:type=%s,clientName=%s",
                        typeName,
