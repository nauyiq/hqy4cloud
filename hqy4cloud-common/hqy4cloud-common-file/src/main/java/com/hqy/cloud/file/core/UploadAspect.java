...
public class UploadAspect {
    ...
    @Pointcut("(execution(public * *(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping) && @annotation(com.hqy.cloud.file.common.annotation.UploadMode)) || "
            + "(execution(public * *(..)) && @annotation(org.springframework.web.bind.annotation.PostMapping) && @annotation(com.hqy.cloud.file.common.annotation.UploadMode)) ")
