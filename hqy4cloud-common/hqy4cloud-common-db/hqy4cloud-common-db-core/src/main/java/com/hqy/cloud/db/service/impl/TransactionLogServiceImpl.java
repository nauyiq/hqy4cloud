...
public class TransactionLogServiceImpl extends ServiceImpl<TransactionLogMapper, TransactionLog> implements TransactionLogService {
    ...
    public TransactionTryResponse tryTransaction(TccRequest tccRequest) {
        ...
        if (exist == null) {
            ...
            return this.save(transactionLog) ? TransactionTryResponse.success(TransTrySuccessType.TRY_SUCCESS) : TransactionTryResponse.failed("TRY_FAILED", BsResultCode.INSERT_FAILED.getMessage());
        }
    ...
    public TransactionConfirmResponse confirmTransaction(TccRequest tccRequest) {
        ...
        if (exist.getStatus() == TransactionActionStatus.TRY) {
            ...
            return this.updateById(exist) ? TransactionConfirmResponse.success(TransConfirmSuccessType.CONFIRM_SUCCESS) : TransactionConfirmResponse.failed("CONFIRM_FAILED", BsResultCode.UPDATE_FAILED.getMessage());
        }
    ...
    public TransactionCancelResponse cancelTransaction(TccRequest tccRequest) {
        ...
        if (exist == null) {
            ...
            return this.save(transactionLog) ? TransactionCancelResponse.success(TransCancelSuccessType.EMPTY_CANCEL) : TransactionCancelResponse.failed("EMPTY_CANCEL_FAILED", BsResultCode.INSERT_FAILED.getMessage());
        }
