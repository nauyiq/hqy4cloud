...
import com.hqy.cloud.registry.api.RegistryManager;
 ...
 * @date 2024/1/3
 */
public class LifecycleDeployer extends AbstractDeployer<LifecycleDeployModel> implements DestroyDeployerService {
    private static final Logger log = LoggerFactory.getLogger(LifecycleDeployer.class);

    private final LifecycleDeployModel deployModel;
    private final ShutdownHook shutdownHook;
    private final Object destroyLock = new Object();
    private final Object startLock = new Object();
    private volatile CompletableFuture<Boolean> startFuture;

    public LifecycleDeployer(LifecycleDeployModel model) {
        super(model);
    ...
    protected void onStarted() {
        try {
            ...
            // start lifecycle
            deployModel.getLifecycle().start();
